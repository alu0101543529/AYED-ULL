...
namespace AED {
  ...
  /**
   * @brief Crea un vector (de copia) con el tamaño solicitado.
   * @param[in] w: referencia (constante) al tamaño del vector.
   */
  template <class T>
  vector_t<T>::vector_t(const vector_t<T>& w) { *this = w; }
   ...
   * @return Devuelve el valor de asignación entre dos elementos en la posición (i) del vector.
   */
  template <class T>
  ...
  /**
   * @brief sobrecarga del operador de flujo de salida (<<) para la clase vector_t.
   * @param[in] os: referencia al objeto ostream (flujo de datos de salida).
   * @param[in] v: referencia (constante) al vector.
   * @return Devuelve los datos que se introdujeron por el usuario, ya en forma de vector.
   */
  template <class T>
  ...
  /**
   * @brief sobrecarga del operador de flujo de entrada (>>) para la clase vector_t.
   * @param[in] is: referencia al objeto istream (flujo de datos de entrada).
   * @param[in] m: referencia (constante) al vector.
